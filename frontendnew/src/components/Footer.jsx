      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 mb-4">
            <h2 className="text-2xl font-bold mb-2">MegaMart</h2>
            <p>Your one-stop shop for all things fashion.</p>
            <p className="mt-2 text-sm">
              &copy; 2024 MegaMart. All rights reserved.
            </p>
          </div>
          ...
          <div className="w-full md:w-1/4 mb-4">
            ...
            <form>
              ...
              />
              <button className="w-full bg-[#8E3E63] text-white py-2 rounded hover:bg-[#6d304f]">
                Subscribe
              </button>
            </form>
          </div>
