...
import Table1 from './States/Table1'
  ...
  return (
    <div className='h-full'>
      ...
      <div className='flex mt-[10vh] h-[calc(100vh - 10vh)] '>
        ...
        {/* Right bar */}
        <div className='w-[80%] ml-[20%] bg-[#f5f5f5] h-full p-4 text-[#2E4767]'>
            <div className='mb-4'>
                WellCome back , Pratik....
            </div>
            <div className='pt-3 flex justify-between flex-wrap pb-2 bg-white mb-3 p-4 py-8 rounded-md'>
                {/* Block */}
                <Block color="ffefce" title="Ecommerce Revenue" content="2,000,000"/>
                <Block color="c9f4cc" title="New Users" content="2,000,000"/>
                <Block color="fadef1" title="New Orders" content="2,000,000"/>
                <Block color="c2effb" title="Total Products" content="2,000,000"/>
